import { loadPopupData } from "../api/dataLoader.js"; import { updatePopupTitles } from "./popupTitles.js"; import { renderPopupExtras, renderSunCard, renderWaveCard, renderTempCard, renderVisibilityCard } from "./popupExtras.js"; import { renderWindCharts } from "../charts/windChart.js"; import { renderSeaLevelCard } from "./seaLevelCard.js"; import { renderWindFlowAnimation } from "./windFlowAnimation.js"; import { currentConditionsCardHTML, renderCurrentWindSummary, renderCurrentSunTimes, updateMergedCardVisibility } from "./currentConditionsCard.js"; export function stationDetailHTML(station) { return `
