// ==========================
// Kevyt popup Open-Meteo-tuuliennusteasemille (esim. Ruotsin
// puolen pisteet, joilla ei ole FMI:n fmisid-tunnusta eikä siten
// havaintoja/lämpötilaa/vedenkorkeutta saatavilla). Näyttää vain
// tuuliennusteanimaation liukusäätimineen ja nappeineen.
// ==========================

import { renderWindFlowAnimation } from "./windFlowAnimation.js";

export function openMeteoWindPopupHTML(station) {
  return `
...
// Palauttaa suoraan stop()-funktion (ei { data, stop } -oliota kuten
// renderStationDetail, koska tälle popupille ei ole muuta dataa).
export async function renderOpenMeteoWindPopup(containerEl, station) {
